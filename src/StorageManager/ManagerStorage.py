...
class ManagerStorage(object):
    ...
    def create(self, key: str, value: i_Storage) -> None:
        """
    ...
    def read(self, key: str) -> i_Storage:
        """
    ...
    def update(self, key: str, value: i_Storage) -> int:
        """
    ...
    def __check_if_value_empty(self, value: i_Storage, ops_name: str) -> None:
        try:
            if value is None:
                self.__logger.debug(f"storage: {self.__storage_name} "
                                    f"operation: {ops_name} "
