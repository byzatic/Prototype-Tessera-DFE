...
from Global2p1.NodeUnit import NodeUnitWorkersPipelineStagesDescriptionStageDataAbstractDataListUnit


class SchemaDtoNodeUnitWorkersPipelineStagesDescriptionStageDataAbstractDataListUnit(Schema):
    ...
    def make_dto(self, data, **kwargs):
        return NodeUnitWorkersPipelineStagesDescriptionStageDataAbstractDataListUnit(**data)
